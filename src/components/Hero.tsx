	...
	return (
		<div className="hero">
			<div className="container">
				<div className="z-2">
					<h2 className="text-primary text-5xl md:text-80 font-black mb-5 leading-none tracking[-0.1875]">Artificial Intelligence</h2>
					<h1 className="text-primary text-6xl md:text-100 font-black leading-80 tracking[-0.1875]">Studio</h1>
			...
			<div 
				className="w-[771px] h-[788px] absolute top-0 right-0 z-[-1] bg-cover hidden md:block" 
				style={{ 
			...
			></div>
			<div 
				className="w-[972px] h-[486px] absolute bottom-0 right-[80px] z-[-1] bg-cover bg-center hidden md:block" 
				style={{ 
