		...
		<div className="hero">
			<div className="container">
				<div className="z-2">
					...
					<a href="#" class="theme-btn mt-[35px] mr-5">Service we provide <i class="fas fa-arrow-right"></i></a>
					<a href="#" class="theme-btn minimal-btn">Let's Chat <i class="fas fa-arrow-right"></i></a>
				</div>
			</div>
			<div 
