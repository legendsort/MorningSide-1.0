  ...
  return (
    <div className="hero md:pt-[330px]">
      <div className="container">
        <div className="z-2">
          <h2 className="text-primary text-3xl lg:text-4xl lg:text-5xl md:text-80 font-black mb-5 leading-none tracking[-0.1875]">
            Artificial Intelligence
          </h2>
          <h1 className="text-primary text-4xl lg:text-5xl lg:text-6xl md:text-100 font-black leading-80 tracking[-0.1875]">
            Studio
          </h1>
