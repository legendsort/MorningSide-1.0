		...
		<div className="section-padding">
			<div className="container">
				<div className="flex flex-col items-center">
					...
					<h2 className="text-primary text-3xl md:text-4xl text-center font-bold mb-2 leading-none max-w-[640px]">Understanding GPT-4: ChatGPT's Successor With Advanced Reasoning</h2>
